...
const App = observer(
  class App extends Component {
    ...
    async handleSignButton(permissionIndex) {
      ...
      let { accountName } = this.props.model.userInfo
    ...
    async handleSignSampleTransaction(
      ...
      try {
        this.clearErrors()
        const transaction = this.createSampleTransaction(
          chainAccount,
          permission
        )
        let signOptions = {
  ...
  */
    ...
    renderSigningOptions() {
      let { permissions } = this.props.model.userInfo
